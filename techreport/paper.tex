...
\usepackage{url, bbm, comment, verbatim}
...
\reportnumber{samba/02/17}
\keywords{Sea level rise; Adaptation; Decision making}
\projectnumber{220730}
\project{eSACP}
\availability{Open}
\frontpagefigure{sealevel-tim-marshall} 
\target{Decision makers and scientists}
\researchfield{Statistics, Climatology, Environmental Economics}
\fi
...
\nrtitle{I don't know, are you sure we want to do this? Sea level adaptation decisions under uncertainty}

\shorttitle{Sea level adaptation decisions under uncertainty}

\author{Thordis L. Thorarinsdottir \email{thordis@nr.no} \and Peter Guttorp \email{peter.guttorp@nr.no} \and Martin Drews \email{mard@dtu.dk} \and Per Skougaard Kaspersen \email{pskk@dtu.dk} \and Karianne de Bruin \email{karianne.debruin@cicero.oslo.no}}

\aboutauthors{Thordis L. Thorarinsdottir is Chief Research Scientist and Peter Guttorp is Professor II at the Norwegian Computing Center in Oslo, Norway. Martin Drews is a Senior Scientist and Per Skougaard Kaspersen is Postdoc at DTU Management Engineering, Technical University of Denmark in Copenhagen, Denmark. Karianne de Bruin is a Senior Researcher at the Center for International Climate and Environmental Research in Oslo, Norway and Researcher at Wageningen Environmental Research in Wageningen, The Netherlands}
